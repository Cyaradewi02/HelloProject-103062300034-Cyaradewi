...
<body style="background-image: url(assets/back20.jpeg); background-repeat: no-repeat; background-size:cover;">
<?php 
	if(isset($_GET['pesan'])){
		if($_GET['pesan']=="gagal"){
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <div class="breadcrumb-item active"><a href="form_siswa.php" style="margin-left:87px; margin-top:25px;">Masuk Sebagai Siswa</a></div>
                </form>
