        ...
        <section class="section">
         ...
         <div class="row">
            ...
            <span class="input-group-text" id="basic-addon1">ID Petugas</span>
                ...
                <input type="text" name="id_petugas" class="form-control" placeholder="" aria-label="masukkan id petugas" aria-describedby="basic-addon1">
                </div>
            ...
            <span class="input-group-text" id="basic-addon1">NISN</span>
                ...
                <input type="text" name="nisn" class="form-control" placeholder="" aria-label="masukkan nisn" aria-describedby="basic-addon1">
                </div>
